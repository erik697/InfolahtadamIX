...
@section('uri')
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Gallery Gambar</li>
...
<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('gallery-images.update', $galleryImage->id) }}" enctype="multipart/form-data">
                @method('put')
                @csrf
              <div class="box-body">
                ...
                <input type="hidden" name="img_url_old" value="{{ $galleryImage->url }}">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $galleryImage->title }}" class="form-control" name="title" id="exampleInputName" placeholder="Masukan Akun" required>
                       @error('title')
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" class="form-control" id="" cols="30" rows="10">{{ $galleryImage->description }}</textarea>
                   @error('description')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror 
                </div>
