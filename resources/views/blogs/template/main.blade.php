...
<link rel="manifest" href="{{ asset('/manifest.json') }}">
            ...
            <div class="lg:flex lg:w-full">
              ...
              <div class="lg:w-2/3 flex lg:justify-center lg:items-center">
                <ul id="nav-menu" class="  mt-8 lg:mt-0 hidden lg:flex">
                  ...
                  <li class="mx-8 border-b-2 lg:border-b-2 border-transparent font-semibold hover:text-orange-600 hover:border-orange-600 {{ Route::currentRouteName() == 'dashboards' ? "text-orange-600 pointer-events-none" : "" }}" ><a href="{{ route('dashboards') }}">Beranda</a></li>


                     {{-- untuk PC/Laptop --}}
                  <li class="relative hidden lg:block group mx-3 lg:border-b-2 border-transparent lg:border-0 font-semibold">
                    <a href="#" class="hover:text-orange-600 {{ Str::startsWith(Route::currentRouteName(), 'profiles.') ? "text-orange-600 pointer-events-none" : "" }}">Profile <i class="fa-solid fa-caret-right rotate-0 lg:group-hover:rotate-90 transition-all"></i></a>
                  ...
                  <li class="mx-8 border-b-2 lg:border-b-2 border-transparent font-semibold hover:text-orange-600 hover:border-orange-600 {{ Route::currentRouteName() == 'articles' ? "text-orange-600 pointer-events-none" : "" }}" ><a href="{{ route('articles') }}">Berita</a></li>

                  {{-- untuk layar pc/laptop --}}
                  <li class="relative hidden lg:block group mx-3 lg:border-b-2 border-transparent lg:border-0 font-semibold">
                    <a href="#" class="hover:text-orange-600 {{ Str::startsWith(Route::currentRouteName(), 'gallery.') ? "text-orange-600 pointer-events-none" : "" }}">Gallery <i class="fa-solid fa-caret-right rotate-0 lg:group-hover:rotate-90 transition-all"></i></a>
                  ...
                  <li class="relative lg:hidden mx-8 lg:border-b-2 lg:border-0 font-semibold">
                    <a href="#" id="humbergerMedia" class="hover:text-orange-600 {{ Str::startsWith(Route::currentRouteName(), 'gallery.') || Route::currentRouteName() == 'articles' ? "text-orange-600 pointer-events-none" : "" }}">Media & Publikasi <i class="fa-solid fa-caret-right rotate-0 lg:group-hover:rotate-90 transition-all"></i></a>
                  ...
                  <li class="mx-8 border-b-2 lg:border-b-2 border-transparent font-semibold hover:text-orange-600 hover:border-orange-600 {{ Route::currentRouteName() == 'ppid.index' ? "text-orange-600 pointer-events-none" : "" }}" ><a href="{{ route('ppid.index') }}">PPID</a></li>

                  {{-- untuk layar pc/laptop --}}

                  <li class="relative hidden lg:block group mx-3 lg:border-b-2 border-transparent lg:border-0 font-semibold">
                    <a href="#" class="hover:text-orange-600 {{ Str::startsWith(Route::currentRouteName(), 'persitArticle.') ? "text-orange-600 pointer-events-none" : "" }}">Persit <i class="fa-solid fa-caret-right rotate-0 lg:group-hover:rotate-90 transition-all"></i></a>
                    <ul class="lg:absolute hidden group-hover:block lg:bg-white text-gray-800 rounded lg:shadow-lg min-w-[120px]">
                  ...
                  <li class="mx-8 border-b-2 border-transparent font-semibold hover:text-orange-600 hover:border-orange-600 {{ Route::currentRouteName() == 'contacts' ? "text-orange-600 pointer-events-none" : "" }}"><a href="{{ route("contacts") }}">Kontak</a></li>
                  ...
                  <li class="mx-8 border-b-2 lg:border-b-2 border-transparent font-semibold hover:text-orange-600 hover:border-orange-600 {{ Route::currentRouteName() == 'pengaduan' ? "text-orange-600 pointer-events-none" : "" }}" ><a href="{{ route('pengaduan') }}">Pengaduan</a></li>
  ...
  <p>&copy; 2025 INFOLAHTADAM IX. All rights reserved.</p>
